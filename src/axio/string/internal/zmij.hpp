#ifndef AXIO_STRING_INTERNAL_ZMIJ_HPP_
#define AXIO_STRING_INTERNAL_ZMIJ_HPP_

// https://github.com/vitaut/zmij/blob/main/zmij.h
// https://github.com/vitaut/zmij/blob/main/zmij.cc
...
ZMIJ_INLINE auto select(uint64_t condition,
                        int64_t true_value,
...
struct data {
  ...
  static constexpr auto pack8(uint8_t a,
                              uint8_t b,
                              uint8_t c,
                              uint8_t d,  //
                              uint8_t e,
...
ZMIJ_INLINE void write_digits(char* buffer,
...
ZMIJ_INLINE auto to_decimal(UInt bin_sig,
                            int64_t raw_exp,
                            bool regular,
